...
if(isset($_POST['submit'])) {
    ...
    if(!empty($_POST['name'])    && !empty($_POST['email'])   && !empty($_POST['password'])  && !empty($_POST['confirmpassword'])     ){
        ...
        $query = "insert into register(name,email,password,confirmpassword) values('$fullname' ,'$phonenumber','$date', '$text')"; 
...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Register Now</h1>
                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control p-4" name="password" placeholder="password" required="required">
                            </div>
                            <div class="form-group">
